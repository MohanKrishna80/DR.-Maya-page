...
const items = [
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1570506097811-83004c7e4691?w=600&auto=format&fit=crop&q=60"
  }
];
      ...
      <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
        {items.map((i, idx) => (
          <div
            ...
            className="p-8 rounded-xl shadow hover:shadow-lg transition flex flex-col transform hover:-translate-y-1"
          >
            ...
            <div className="mt-6 flex justify-center">
              <img
                src={i.img}
                alt={i.title}
                className="w-80 h-80 object-cover rounded-full shadow transition-transform duration-700 hover:scale-105"
              />
            </div>
          </div>
        ))}
